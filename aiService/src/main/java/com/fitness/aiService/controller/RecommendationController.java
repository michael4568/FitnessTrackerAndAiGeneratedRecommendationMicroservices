...
public class RecommendationController {
    ...
    @io.github.resilience4j.ratelimiter.annotation.RateLimiter(name = "fetchRecommendation")
    ...
    public ResponseEntity<ChatResponse> handleRateLimitException(io.github.resilience4j.ratelimiter.RequestNotPermitted e) {
        return ResponseEntity.status(HttpStatus.TOO_MANY_REQUESTS).body(new ChatResponse("AI rate limit exceeded. Please wait or use a custom API key."));
    }
    ...
    public ResponseEntity<ChatResponse> chatOnUserPage(
        ...
        String limiterName = (customApiKey != null && !customApiKey.trim().isEmpty()) ? "customChat" : "freeChat";
